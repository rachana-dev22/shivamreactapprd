...
export default function FrontPage() {
  ...
  return (
    <>
      <AppBar sx={{ backgroundColor: "rgba(0, 0, 0, 0.25)", padding: "0 1vh", backdropFilter: "blur(10px)", position: "fixed", top: 0, left: 0, right: 0, zIndex: 1100 }}>
        <Toolbar>
          <img src="/128.png" alt="Logo" style={{ width: 40, height: 40, marginRight: 8, filter: "drop-shadow(0 0px 4px rgba(255, 255, 255, 0.4))" }} />
          <Typography variant="h5" component="div" sx={{ flexGrow: 1, color: "#fff", fontFamily: "Mulish, sans-serif", fontWeight: 550 }}></Typography>
          <Box>
            <Button
              startIcon={<LoginIcon />}
              variant="contained"
      ...
      >
        <Box sx={{ paddingTop: 20, backgroundImage: "linear-gradient(to bottom, rgba(0, 0, 0, 0.6), rgba(255, 255, 255, 0.2))", width: "100%", height: "auto" }}>
          <Box
            sx={{
              background: "linear-gradient(to bottom, rgba(0, 0, 255, 0.6), rgba(255, 255, 255, 0.2))",
              borderRadius: "20px",
              boxShadow: "inset 0 0px 10px 0 rgba(0, 0, 0, 0.3), 0 5px 14px 0 rgba(0, 0, 0, 0.5)",
              padding: "40px",
              textAlign: "center",
              maxWidth: "900px",
              margin: "0 auto",
        ...
        <Box
          sx={{
            backgroundImage: "linear-gradient(to bottom, rgba(255, 255, 255, 0.2), rgba(0, 0, 0, 1))",
            padding: "4em 2em",
            color: "white",
            textAlign: "center",
            width: "100%",
          ...
          >
            <Box
              sx={{
                ...
                boxSizing: "border-box",
                borderRadius: "16px",
                background: "linear-gradient(to top, rgba(0, 0, 255, 0.3), rgba(255, 255, 255, 0.3))",
                color: "#fff",
                textAlign: "center",
                fontSize: "1.2rem",
                boxShadow: "inset 0 0px 10px 0 rgb(0, 0, 0, 0.5), 0 0px 10px rgba(0, 0, 0, 0.3)",
                transition: "transform 0.3s ease, box-shadow 0.3s ease",
                fontFamily: "Mulish, sans-serif",
                maxWidth: "100%", // Limits the width of each box to its container
                "&:hover": {
            ...
            >
              ...
              <Typography variant="body2" sx={{ fontSize: "1rem", color: "rgba(255, 255, 255, 0.6)", marginTop: "0.5em", display: "block", fontFamily: "Mulish, sans-serif" }}>
      ...
      {/* <Box
        sx={{
          backgroundImage: "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/herobackgroundnewblurred.png)",
          backgroundSize: "cover",
